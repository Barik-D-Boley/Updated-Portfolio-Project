        ...
        stuff.push(  
            <div className="project-card" key={i}>
                ...
                <div className="project-card-info">
                    <h2 className="project-title">{ProjectName}</h2><a href={WebsiteLink} target="_blank" rel="noreferrer" className="website-link" title={`${ProjectName} link`} ><BiLinkExternal /></a>
