            ...
            <div className="website-container-div">
                <div className="homepage-container-div">
                    ...
                    <div id="profile-information">
                        ...
                        <div id="socials">
                            <a href="sms:602-668-6436"><FaPhoneAlt id="phone-icon" className="icon" title="Phone number link" /></a>
                            <a href="mailto:barik.boley@gmail.com"><MdEmail id="email-icon" className="icon" title="Email link" /></a>
                            ...
                            <a href="https://github.com/xBarikadex" target="_blank" rel="noreferrer"><BsGithub id="github-icon" className="icon" title="Github link" /></a>
                        </div>
                    </div>
                </div>
            </div>
