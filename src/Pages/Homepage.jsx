            ...
            <div className='container-div'>
                <div className='content-div'>
                    ...
                    <div id='socials'>
                        ...
                        <a href='https://www.linkedin.com/in/barik-boley-b2088820b/' target='_blank'><BsLinkedin className='icon' /></a>
                        <a href='https://github.com/BarikBoley' target='_blank'><BsGithub className='icon' /></a>
                    </div>
                </div>
            </div>
            <Footer />
